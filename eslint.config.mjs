...
export default tseslint.config({
  ignores: ['dist/**', 'node_modules/**', 'storybook-static/**', 'vite.config.*', 'vitest.config.*', '**/*.svelte.ts'],
}, // TypeScript recommended rules.
...tseslint.configs.recommended, // Svelte base config (parser + core rules only).
eslintPluginSvelte.configs['flat/base'], // Project-specific tweaks.
{
  files: ['**/*.ts', '**/*.tsx'],
  languageOptions: {
    sourceType: 'module',
