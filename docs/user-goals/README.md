...
| [04-nodes-and-parameters.md](./04-nodes-and-parameters.md) | Nodes & Parameters | Edit params, drivers + graph wires, input modes, live values, color/enum, file |
| [05-connections.md](./05-connections.md) | Connections | Graph wires, one per port, input modes with drivers; GPU validity (wire-time in WebGPU) |
| [06-audio.md](./06-audio.md) | Audio | Files, bands/remappers, playback, scrub, audio drivers, persist |
| [07-timeline-and-automation.md](./07-timeline-and-automation.md) | Timeline & Automation | Transport, animation drivers, curves/evaluation, persist |
| [12-parameter-drivers.md](./12-parameter-drivers.md) | Parameter Drivers | Unified port-centric drivers (audio, animation, MIDI envelope planned); panel UX intent |
