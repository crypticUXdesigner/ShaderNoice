...
| [`advanced-2d-fractals/_OVERVIEW.md`](./advanced-2d-fractals/_OVERVIEW.md) | **Active:** Expand Patterns **Fractal** — escape family/smooth/DE, orbit traps, Newton/Lyapunov, shape-modulus Julia; flames/RD spike |
| [`arch-perf-remediation/_OVERVIEW.md`](./arch-perf-remediation/_OVERVIEW.md) | **Shipped (2026-08-09):** Architecture & performance remediation — shared WebGPU pass executor, compile-contract, worker/frame/export CPU, change-detection, ownership/docs closeout |
| [`arch-perf-followups/_OVERVIEW.md`](./arch-perf-followups/_OVERVIEW.md) | **Shipped (2026-08-09):** Review follow-ups — App shell modules, export dialog inversion (`runImageExport` / `runVideoExport`), WebGPU validation injection, GLSL+WebGPU hash-skip, offline analysis hop (60/120 Hz) |
