...
| [`arch-perf-remediation/_OVERVIEW.md`](./arch-perf-remediation/_OVERVIEW.md) | **Active:** Architecture & performance remediation — shared WebGPU pass executor, compile-contract, worker/frame/export CPU, change-detection |
