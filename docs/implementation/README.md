...
| [`arch-perf-followups/_OVERVIEW.md`](./arch-perf-followups/_OVERVIEW.md) | **Active:** Review follow-ups — App shell split, export dialog inversion, WebGPU validation injection, incremental/hash-skip compile, offline analysis cost |
