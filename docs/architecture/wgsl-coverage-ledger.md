...
| `arrangement-lanes` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `arrangement-notes` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `blend` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `bloom-sphere` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `blur` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `bokeh` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `bokeh-point` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `boundary-shutter-rays` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `cellular-slip` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `chord-voronoi-bloom` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `chromatic-aberration` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `circle-inversion` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `color-gradient` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `color-grading` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `color-lut` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `crease-fold` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `duration-comet-trails` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `mask-composite-vec2` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `mobius-portal` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `note-gravity-warp` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `note-ripple-field` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `oklch-color` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `oklch-color-map` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `path-drive` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `pitch-class-compass` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `pixelize` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `plane-grid` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `plane-project` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `rhythm-stripe-field` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `track-halo-lattice` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `transform` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `uv-band-shift` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
| `uv-block-glitch` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `velocity-spark-grid` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
...
| `wake-smear` | supported | inline | WGSL MVP; keep in sync with `WGSL_SUPPORTED_NODE_TYPES` in `WgslMvpCompiler.ts`. |
