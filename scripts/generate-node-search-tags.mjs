...
const OVERRIDES = {
  ...
  'note-ripple-field': ['midi', 'ripple', 'arrangement', 'pattern', 'onset'],
  'pitch-class-compass': ['midi', 'compass', 'arrangement', 'pattern', 'harmonic', 'chord'],
  'rhythm-stripe-field': ['midi', 'wave', 'wavefield', 'arrangement', 'pattern', 'density', 'warp'],
  'velocity-spark-grid': ['midi', 'spark', 'arrangement', 'pattern', 'grid', 'drum'],
  'track-halo-lattice': ['midi', 'halo', 'arrangement', 'pattern', 'track', 'lattice'],
  'boundary-shutter-rays': ['midi', 'shutter', 'arrangement', 'pattern', 'section', 'rays'],
  'duration-comet-trails': ['midi', 'comet', 'arrangement', 'pattern', 'trail', 'onset'],
  'chord-voronoi-bloom': ['midi', 'voronoi', 'arrangement', 'pattern', 'harmonic', 'cells'],
  'note-gravity-warp': ['midi', 'gravity', 'arrangement', 'pattern', 'warp', 'distort'],
  ...
  'crease-fold': ['fold', 'crease', 'mirror', 'hinge', 'distort'],
  'cellular-slip': ['voronoi', 'cellular', 'slip', 'glass', 'distort', 'cells'],
  'mobius-portal': ['mobius', 'portal', 'conformal', 'disk', 'distort', 'lens'],
  'wake-smear': ['wake', 'smear', 'trail', 'datamosh', 'motion', 'distort', 'drag'],
  'circle-inversion': ['circle', 'inversion', 'invert', 'bubble', 'conformal', 'distort', 'uv'],
